...
} from "../prompts/report-v1.js";
import { FALLBACK_SWAPS } from "./fallback-swaps.js";
...
// Palabras prohibidas en la narrativa de salud
// Nota: \b no reconoce vocales acentuadas (á, é, etc.) como límite de palabra
// en JS (no son \w). Para palabras que terminan en vocal acentuada se usa
// un lookahead de espacio/puntuación en lugar de \b final.
...
// Narrativas de fallback fijas por nivel (no generadas por IA).
// Exportado también para los tests automáticos de eval/test-guard.ts.
...
export async function runGuard(
  ...
  // ── Resultado con fallbacks donde corresponda ──────────────────────────────
  return {
